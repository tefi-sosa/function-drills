...
function bestMovie (movieName) {
  console.log(`${movieName} is the best movie ever!`);
}
...
function amountToBuy (gold) {
  let chocolateFrog = 3;
  return Math.floor(gold / chocolateFrog)
}

let totalFrogs = amountToBuy(4);
